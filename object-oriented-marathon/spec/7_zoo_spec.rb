...
RSpec.describe Zoo do
  ...
  describe ".new" do
    it "should take the name of the zoo, season opening date, and season closing date as a required argument" do
  ...
  describe "#add_animal" do
    ...
    it "should return an error message if there are no empty cages" do
      10.times do |i|
      ...
      expect(zoo.add_animal(python)).to eq("Your zoo is already at capacity!")
    end
  end
